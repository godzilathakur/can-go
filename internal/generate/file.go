...
func Imports(f *File) {
	...
	f.P(`"time"`)
	f.P()
	f.P(`"github.com/godzilathakur/can-go"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/socketcan"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/candebug"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/canrunner"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/descriptor"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/generated"`)
	f.P(`"github.com/godzilathakur/can-go/pkg/cantext"`)
	f.P(")")
	f.P()
