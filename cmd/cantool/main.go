...
import (
	...
	"github.com/godzilathakur/can-go/internal/generate"
	"github.com/godzilathakur/can-go/pkg/dbc"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/definitiontypeorder"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/intervals"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/lineendings"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/messagenames"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/multiplexedsignals"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/newsymbols"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/nodereferences"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/noreservedsignals"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/requireddefinitions"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/signalbounds"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/signalnames"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/singletondefinitions"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/siunits"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/uniquenodenames"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/uniquesignalnames"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/unitsuffixes"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/valuedescriptions"
	"github.com/godzilathakur/can-go/pkg/dbc/analysis/passes/version"
